...
const InstitutionPostFeed = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto py-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900">Institution Post Feed</h1>
          <p className="text-gray-600 mt-2">Share announcements and engage with your alumni community</p>
        </div>
...
export default InstitutionPostFeed;